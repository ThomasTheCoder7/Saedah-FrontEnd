...
const ProfileHeader = () => {
  ...
  return (
    <>
      <View style={{alignItems:'center', justifyContent:i18n.language=='en'?'flex-end':'flex-end', flexDirection:i18n.language=='en'?'row':'row-reverse', paddingHorizontal:10, paddingVertical:5}}>
          <LogoutButton onPress={()=>setModalVisible(true)}/>
          <LogoutAlert modalVisible={modalVisible} setModalVisible={setModalVisible}/>
          <SettingLink/>  
      </View>
    </>
  );  
